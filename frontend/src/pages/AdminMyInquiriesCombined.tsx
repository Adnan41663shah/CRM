...
import AdminMyAttendedInquiries from './AdminMyAttendedInquiries';
import AdminMyRaisedInquiries from './AdminMyRaisedInquiries';
import { cn } from '@/utils/cn';

const STORAGE_KEY = 'admin-my-inquiries-active-tab';

const AdminMyInquiriesCombined: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-4">
        {activeTab === 'attended' ? <AdminMyAttendedInquiries /> : <AdminMyRaisedInquiries />}
      </div>
    </div>
  );
};

export default AdminMyInquiriesCombined;
